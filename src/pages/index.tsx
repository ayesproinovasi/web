...
function Home(session: Sessions) {
  ...
  const handleSubmitEmail = async () => {
    try {
      ...
      window.open(
        `mailto:info@ptayesproinovasi.com?subject=${subject}&body=${body}`,
        "_blank"
      );
    } catch (error) {
  ...
  const handleSubmitMap = async () => {
    try {
      // Open Gmail with pre-filled details
      window.open(`https://maps.app.goo.gl/vcPz5ck7erdERAwp8 `, "_blank");
    } catch (error) {
      console.error("Validation failed:", error); // Handle validation errors if needed
    }
  };
    ...
    <>
      ...
      >
        <Row gutter={[16, 24]}>
          <Col xs={24} sm={24} md={8} lg={8}>
            ...
            <p
              ...
              style={{ color: themeColor?.gray300, cursor: "pointer" }}
            >
              JL.Rukan La Riviera Garden Blok A No.22, Kel. <br /> Lemo, Kec.
              Teluknaga, Kab. Tangerang, <br />
          ...
          <Col xs={24} sm={24} md={8} lg={8}>
            ...
            <Row style={{ marginBottom: 10 }}>
              <a onClick={() => handleSubmitEmail()}>
                ...
                />
                <Text style={{ color: themeColor?.gray300 }}>
                  info@ptayesproinovasi.com
                </Text>
              </a>
            </Row>
            <Row>
              ...
              />
              <Text style={{ color: themeColor?.gray300 }}>+622139711788</Text>
            </Row>
          </Col>
          <Col xs={24} sm={24} md={8} lg={8}>
        ...
        <Row>
          <PushpinOutlined
            rev={""}
            style={{ fontSize: "22px", color: themeColor?.gray300 }}
          />
          <p
            onClick={() => handleSubmitMap()}
            style={{
        ...
        >
          <Col span={14}>
            <p style={{ padding: 0 }}>PT. AYES PRO INOVASI</p>
          </Col>
          <Col span={10}>
